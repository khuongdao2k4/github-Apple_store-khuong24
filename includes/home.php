...
<body>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
                        <?php if(isset($_SESSION['username']) && isset($_SESSION['role'])): ?>
                            <li><span class="dropdown-item">Hi, <?php echo $_SESSION['role'] . ' ' . $_SESSION['username']; ?>!</span></li>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Hiệu ứng chữ chạy trên navbar
            const navbarBrand = document.querySelector(".navbar-brand");
            setInterval(() => {
                navbarBrand.style.color = navbarBrand.style.color === "#ff007f" ? "#5a00ff" : "#ff007f";
            }, 1000);
        });
    </script>
