...
<head>
    ...
    <style>
        ...
        .deals-container img {
            height: 20px; /* Giảm kích thước ảnh để phù hợp với cỡ chữ nhỏ hơn */
            margin-right: 8px;
        }
        .deal-item {
            display: flex;
        ...
        .see-all {
            ...
            color: #007bff;
            font-weight: bold;
            font-size: 13px; /* Giảm cỡ chữ của link */
        }
        .deal-info {
            min-width: 180px; /* Đảm bảo chiều ngang đủ để chứa hết chữ */
        ...
        .rf-bfe-column-left, .rf-bfe-column-right {
            width: 65%;
            max-height: 600px;
            overflow-y: scroll;
            scrollbar-width: none;
        }
        .rf-bfe-column-left::-webkit-scrollbar, .rf-bfe-column-right::-webkit-scrollbar {
            display: none;
        }
        .rf-bfe-column-right {
            width: 35%;
...
<div class="deals-container">
    ...
    <div class="deal-item">
        <img src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/desktop-bfe-iphone-step1-bugatti-banner-att?wid=24&hei=24&fmt=png-alpha&.v=1658193314821" alt="Carrier 1">
        <span>Save up to $1000 after trade-in.</span>
    </div>
    <div class="deal-item">
        <img src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/desktop-bfe-iphone-step1-bugatti-banner-lightyear?wid=24&hei=24&fmt=png-alpha&.v=1724793407797" alt="Carrier 2">
        <span>Save up to $1000. No trade-in needed.</span>
    </div>
    <div class="deal-item">
        <img src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/desktop-bfe-iphone-step1-bugatti-banner-tmobile?wid=24&hei=24&fmt=png-alpha&.v=1658193314615" alt="Carrier 3">
        <span>Save up to $1000 after trade-in.</span>
    </div>
    <div class="deal-item">
        <img src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/desktop-bfe-iphone-step1-bugatti-banner-verizon?wid=24&hei=24&fmt=png-alpha&.v=1725054383893" alt="Carrier 4">
        <span>Save up to $1000 after trade-in.</span>
    </div>
</div>
...
<div class="purchase-container">
    <div>
        ...
        <div class="apple-intelligence">
            <img src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-selector-icon-apple-intelligence-202409?wid=17&hei=21&fmt=p-jpg&qlt=95&.v=1724970464935" alt="Apple Intelligence">
...
<div class="rf-bfe-main row">
    <div class="rf-bfe-column-left">
        <img src="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/iphone-16-pro-model-unselect-gallery-1-202409?wid=5120&hei=2880&fmt=webp&qlt=70&.v=aWs5czA5aDFXU0FlMGFGRlpYRXk2UWFRQXQ2R0JQTk5udUZxTkR3ZVlpTEJnOG9obkp6NERCS3lnVm1tcnlVUjBoUVhuTWlrY2hIK090ZGZZbk9HeE1xUVVnSHY5eU9CcGxDMkFhalkvT0NuWUpOMGpEMHVTZEtYYVA3c1B3UzVmbW94YnYxc1YvNXZ4emJGL0IxNFp3&traceId=1" alt="Product Image" style="width:930px; height: 570px; padding-bottom: 50px;">
        
        <h3><strong>Apple Trade In.</strong> Get $40–$630 credit toward your new iPhone.</h3>
        <div class="trade-options">
            <div class="trade-card" style="font-size: 19px;">Select a smartphone<br><small style="font-size: 12px; font-weight: lighter;">Answer a few questions to get your estimate.</small></div>
            <div class="trade-card" style="font-size: 19px;"><p style="padding-top: 12px;">No trade-in</p></div>
        </div>

        <h3><strong>Payment options.</strong> Select the one that works for you.</h3>
        <div class="payment-options">
            <div class="payment-card"><strong>Buy</strong><p>Pay with Apple Pay or other payment methods.</p></div>
            <div class="payment-card"><strong>Finance</strong><p>Pay over time at 0% APR.</p></div>
            <div class="payment-card"><strong>Apple iPhone Upgrade Program</strong><p>Pay monthly at 0% APR with the option to upgrade to a new iPhone every year.</p></div>
        </div>
    </div>
